 ...
 */
package de.codekings.client.GUI.Katalog.CoverFlow;
...
public class CoverFlow extends Region {
    ...
    class PerspectiveImage extends Parent {
        static final double REFLECTION_SIZE = 0.25;
        static final double WIDTH = 300;
        static final double HEIGHT = WIDTH + (WIDTH*REFLECTION_SIZE)+200;
        static final double RADIUS_H = WIDTH / 2;
        static final double BACK = WIDTH / 10;
