...
Source Server         : Fallstudie
Source Server Version : 50538
Source Host           : 85.214.203.217:3306
...
CREATE TABLE `tbl_kunde` (
  ...
  `account_model` int(11) DEFAULT NULL,
  PRIMARY KEY (`KU_ID`),
  KEY `User` (`U_ID`),
  KEY `AccountModel` (`account_model`),
  CONSTRAINT `AccountModel` FOREIGN KEY (`account_model`) REFERENCES `tbl_account_model` (`KUM_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- ----------------------------
INSERT INTO `tbl_kunde` VALUES ('1', '1', '2010-00-00', '12', '1');
...
-- Records of tbl_user
-- ----------------------------
INSERT INTO `tbl_user` VALUES ('1', 'Koschke', 'Jan', 'Erbastraße', '26', '70736', 'Fellbach', 'start123', '2147483647', 'jankoschke@googlemail.com', '0000000027');
INSERT INTO `tbl_user` VALUES ('2', 'Brambor', 'Heiko', '-', '0', '-', '-', 'start123', '1023185', 'heiko.brambor@t-online.de', '0000000028');
