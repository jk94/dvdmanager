...
public class Krypter_2 {
     ...
     * @throws Exception     
     */
    public Krypter_2(Key k, String verfahren) throws Exception {
        this.key = k;
...
// Daten mit AES entschluesseln
    ...
    /**
     * Verschluesselt einen Text in BASE64     * @param text Klartext     *
     * @return BASE64 String     * @throws Exception
    
     */
